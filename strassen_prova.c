               ...
               const size_t n)
{
  ...
  float **D;
  const size_t D_f_row;
  const size_t D_f_col;
  ...
  // S1 = B12 - B22
  sub_matrix_blocks(D,D1X,DX1,
                    B,B1X,BX2,
                    B,B2X,BX2,
                    n2);

  // P1 = A11 x S1 in D1
  strassen_aux(D,D1X,DX1,
               A,A1X,AX1,
               D,D1X,DX1,
               n2);

  // S2 = A11 + A12
  sum_matrix_blocks(D,D1X,DX2,
                    A,A1X,AX1,
                    A,A1X,AX2,
                    n2);
  ...
  // P2 = S2 x B22
  strassen_aux(D,D1X,DX2,
               D,D1X,DX2,
               B,B2X,BX2,
               n2);

  // S3 = A21 + A22
  sum_matrix_blocks(D,D2X,DX1,
                    A,A2X,AX1,
                    A,A2X,AX2,
                    n2);
  ...
  // P3 = S3 x B11
  strassen_aux(D,D2X,DX1,
               D,D2X,DX1,
               B,B1X,BX1,
               n2);

  // S4 = B21 - B11
  sub_matrix_blocks(D,D2X,DX2,
                    B,B2X,BX1,
                    B,B1X,BX1,
                    n2);

  // P4 = A22 x S4
  strassen_aux(D,D2X,DX2,
               A,A2X,AX2,
               D,D2X,DX2,
               n2);
  ...
  // S9 = A11 - A21
  sub_matrix_blocks(D,D1X,DX2,
                    A,A1X,AX1,
                    A,A2X,AX1,
                    n2);

 // S10 = B11 + B12
  sum_matrix_blocks(D,D2X,DX2,
                    B,B1X,BX1,
                    B,B1X,BX2,
                    n2);
